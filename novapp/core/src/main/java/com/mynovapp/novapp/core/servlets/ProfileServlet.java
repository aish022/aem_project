package com.mynovapp.novapp.core.servlets;
...
import com.mynovapp.novapp.core.models.UserInfoModel;

@Component (service=Servlet.class,enabled=true, immediate=true,configurationPid="com.mynovapp.novapp.core.servlets.ProfileServlet",
property={
		Constants.SERVICE_DESCRIPTION + "= Profile Details Servlet",
		"sling.servlet.methods=" + HttpConstants.METHOD_GET,
		"sling.servlet.paths="+ "/services/retrieveprofiledetails",
...
public class ProfileServlet extends SlingSafeMethodsServlet {
	...
	protected void doGet(final SlingHttpServletRequest req,
		...
		try {
			...
			Resource resource = resourceResolver.getResource("/content/modelapp/en/employee");
